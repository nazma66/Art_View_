...
public class Circle_Image_Horizontal_Adapter extends RecyclerView.Adapter<Circle_Image_Horizontal_Adapter.ViewHolder>{
...
//    private ArrayList<String> mLinks;
    ...
    public Circle_Image_Horizontal_Adapter(Context context, ArrayList<String> imageNames, ArrayList<String> images, ArrayList<String> type) {
...
//        mLinks= links;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.circle_image_horizontal_layout, parent, false);
